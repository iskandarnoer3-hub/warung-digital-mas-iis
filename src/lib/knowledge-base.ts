...
const KNOWLEDGE_BASE: KBRule[] = [
  {
    keywords: ['halo', 'hai', 'hi', 'hello', 'assalam', 'pagi', 'siang', 'sore', 'malam', 'selamat'],
  ...
  {
    keywords: ['jam buka', 'jam operasional', 'buka jam', 'kapan buka', 'jam berapa', 'buka gak', 'tutup'],
  ...
  {
    keywords: ['lokasi', 'alamat', 'dimana', 'tempat', 'cabang', 'kantor'],
  ...
  {
    keywords: ['kontak', 'wa', 'whatsapp', 'nomor', 'telepon', 'hp', 'hubungi', 'kontak'],
    response: `Kontak Mas Iis - Warung Solusi:\nWhatsApp: ${WA_NUMBER}\nChat: ${WA_LINK}\n\nTim kami siap bantu kakak. Kirim pesan kapan saja, insya Allah dibalas cepat 🙏`,
  },
  {
    keywords: ['daftar jasa', 'jasa apa', 'jasa apa aja', 'layanan', 'menu', 'semua jasa', 'jasa tersedia'],
  ...
  {
    keywords: ['harga', 'biaya', 'tarif', 'berapa', 'murah', 'mahal', 'cost', 'bayar'],
  ...
  {
    keywords: ['order', 'pesan', 'cara pesan', 'cara order', 'booking', 'daftar', 'gimana cara'],
  ...
  {
    keywords: ['garansi', 'jaminan', 'garansi gak', 'aman'],
  ...
  {
    keywords: ['laptop', 'macbook', 'komputer', 'servis hp', 'pc', 'elektro'],
  ...
  {
    keywords: ['skripsi', 'tesis', 'disertasi', 'jurnal', 'ilmiah', 'bimbingan', 'kuliah', 'tugas akhir'],
  ...
  {
    keywords: ['turnitin', 'plagiarisme', 'similarity', 'cek ai', 'plagiarism'],
  ...
  {
    keywords: ['desain', 'grafis', 'logo', 'banner', 'vektor', 'edit foto', 'photoshop'],
  ...
  {
    keywords: ['website', 'web', 'aplikasi', 'online shop', 'toko online', 'landing page'],
  ...
  {
    keywords: ['kaligrafi', 'arab', 'islami', 'arabian'],
